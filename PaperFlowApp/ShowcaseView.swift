...
struct ShowcaseView: View {
    ...
    private var applyView: some View { VStack(alignment: .leading, spacing: 16) { Label("Explicit apply required", systemImage: "hand.raised.fill").font(.title2.bold()).foregroundStyle(.orange); Text("This showcase stops before any Zotero write. The normal application still requires credentials, confirmation text, and an explicit apply action."); HStack { Button("Back to plan") { step = .plan }; Button("Apply changes") {}.disabled(true) } }.padding(24).background(Color.orange.opacity(0.09)).clipShape(RoundedRectangle(cornerRadius: 7)) }
